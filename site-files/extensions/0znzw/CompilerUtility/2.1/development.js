...
/* eslint-disable */
// @ts-ignore
var get$compilerUtility = (function() {
    function anon$compilerUtility(Q3JlYXRlZCBieSAwem56dy4KaHR0cHM6Ly9zY3JhdGNoLm1pdC5lZHUvMHpuencvCkRPIE5PVCBSRU1PVkUgVEhJUw) {
        ...
        let compilerExport = {_: 'FAIL'};
        if (!hasOwn(opts, 'enableDebug')) opts.enableDebug = false;
        if (!hasOwn(opts, 'vmExpose')) opts.vmExpose = true;
        const messages = {
            missing_tw: {
        ...
        let internal = Compiler.__internal__;
        ...
        const JSGenerator = Compiler.tools.JSGenerator;
        const ScriptTreeGenerator = Compiler.tools.ScriptTreeGenerator;
        const IRGenerator = Compiler.tools.IRGenerator;
        ...
        if (opts.vmExpose) {
            // @ts-expect-error
            vm.exports.Compiler = compilerExport;
            vm.constructor.prototype.compiler = Compiler;
            // @ts-expect-error
            vm.compiler = Compiler;
        }
    
        return {
            Compiler, compilerExport
        };
    }
